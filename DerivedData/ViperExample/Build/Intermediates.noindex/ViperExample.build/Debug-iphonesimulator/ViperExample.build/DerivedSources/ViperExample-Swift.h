...
#ifndef VIPEREXAMPLE_SWIFT_H
#define VIPEREXAMPLE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ViperExample",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12ViperExample11AppDelegate")
...
SWIFT_CLASS("_TtC12ViperExample13SceneDelegate")
